<template>
	<div class="block">
		<div class="block__title">Добавить новую характеристику</div>
		<form method="POST" class="block__content block__form block-form">
			<div class="block-form__items">
				...
				<div
					...
					<button
						type="submit"
						@click.prevent="$store.dispatch('sendSpecification', 'storeSpecification')"
...
<script>
    ...
    export default {
		...
		components: {
			'specifications-popup': SpecificationPopup
		}
    }
</script>