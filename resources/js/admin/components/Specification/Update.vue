<template>
	<div class="block">
		<div class="block__title">Редактирование характеристику: <button @click="$store.dispatch('deleteSpecification', $store.getters.specification[$store.getters.specification.length - 1].id)" type="button" class="_error">( удалить )</button></div>
