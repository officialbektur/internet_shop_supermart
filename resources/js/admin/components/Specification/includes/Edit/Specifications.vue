<template>
	<router-link :to="{ name: 'specifications.update', params: { id: specification.id } }" v-if="!specification.children" class="block-list">
	...
	<div v-else class="block-sublist">
		<div class="block-sublist__button">
		...
		<div hidden class="block-sublist__menu">
			<router-link :to="{ name: 'specifications.update', params: { id: specification.id } }" class="block-list__default block-list-default block-list">
				<div class="block-list__name block-list-default__title">
					Изменить эту категорию: {{ specification.name }}
				</div>
			</router-link>
			<specifications v-for="specification in specification.children" :specification="specification" :key="specification"></specifications>
		</div>
	</div>
</template>
