<template>
	<div class="block">
		<div class="block__title">Редактировать теги</div>
		<ul class="block__content">
			<template v-if="tags.length > 0" v-for="tag in tags" :key="tag.id">
				<router-link :to="{ name: 'tags.update', params: { id: tag.id ?? 0 } }" class="block-list">
