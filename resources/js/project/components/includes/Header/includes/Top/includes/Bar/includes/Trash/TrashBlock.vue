<template>
	<router-link :to="{ name: 'trash' }" class="header-top-bar__block header-top-bar-block a-hover-bgc">
		<span class="header-top-bar-block__info header-top-bar-block-info">
			...
			<span class="header-top-bar-block-info__number">{{ $store.getters.countTrashTovars }}</span>
		</span>
