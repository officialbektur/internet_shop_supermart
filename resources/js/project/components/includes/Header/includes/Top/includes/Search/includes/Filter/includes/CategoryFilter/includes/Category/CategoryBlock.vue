<template>
	<div class="header-top-search-filter-menu-item__content bkt-catygory"  :class="{ '_active': isActiveMenuFillter }">
		<div @click="$store.dispatch('openCategories', $event)" class="bkt-catygory__button bkt-catygory-button a-hover-bgc"  :class="{ '_active': $store.getters.categoryTitle }">
			...
			<span @click="$store.dispatch('clearCategoryTitle')" class="bkt-catygory-button__clear a-hover-bgc">
		...
		<div class="bkt-catygory__menu bkt-catygory-menu">
			<div class="bkt-catygory-menu__header bkt-catygory-menu-header">
				...
				<button @click="$store.dispatch('closeCategories')" type="button" class="bkt-catygory-menu-header__close bkt-catygory-menu-header-close a-hover-bgc">
			...
			<div class="bkt-catygory-menu__main bkt-catygory-menu-main">
				...
				<template v-else>
					<div class="bkt-catygory-menu-main__null">Нету данных!</div>
				</template>
			</div>
		</div>
	</div>
...
<script>
	...
	export default {
		...
		computed: {
			isActiveMenuFillter() {
				return this.$store.getters.isActiveMenuFillter;
			},
		},
		components: {
