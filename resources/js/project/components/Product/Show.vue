				...
				<div class="moreinfo-tovar__info moreinfo-tovar-info">
					...
					<div class="moreinfo-tovar-info__textinfo moreinfo-tovar-info-textinfo">
						...
						<div class="moreinfo-tovar-info-textinfo__ratinginfo moreinfo-tovar-info-textinfo-ratinginfo">
							...
							<a href data-goto-header data-goto=".moreinfo-tovar-body-reviews__comentary" class="moreinfo-tovar-info-textinfo-ratinginfo__column moreinfo-tovar-info-textinfo-ratinginfo__viewreviews moreinfo-tovar-info-textinfo-ratinginfo-viewreviews">
				...
				<div class="moreinfo-tovar__content">
					...
					<div class="moreinfo-tovar-body">
						<div class="moreinfo-tovar-body__specifications moreinfo-tovar-body-specifications">
							...
							<dl v-for="specification in product.specifications" :key="specification" class="moreinfo-tovar-body-description__block">
								<dt>
									<strong class="moreinfo-tovar-body-description__title">{{ specification.name }}: </strong>
								</dt>
								<dd v-for="item in specification.data" :key="item" class="moreinfo-tovar-body-description__btext">{{ item.name }}</dd>
							</dl>
						</div>
