...
class ShowResource extends JsonResource
{
	...
	public function toArray(Request $request): array
	{
		...
		return [
			"id" => $this->id,
			"title" => $this->title,
			"media" => isset($media[$this->id])
							? \App\Http\Resources\Project\Media\ShowResource::collection($media[$this->id])
							: [['src_max' => asset('storage/project/product/default/default.png'), 'src_min' => asset('storage/project/product/default/default.png')]],
